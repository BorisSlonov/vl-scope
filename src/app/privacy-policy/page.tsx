...
export const metadata: Metadata = {
  title: "Политика в отношении обработки персональных данных | VIBRO-LASER",
  description: "Политика компании ООО «КСК-СИСТЕМС» по обработке и защите персональных данных пользователей оборудования VIBRO-LASER.",
};
...
export default function PrivacyPolicy() {
  ...
  const host = headersList.get("host") ?? "vibro-laser.ru";
          ...
          <div className={styles.content}>
            ...
            <section className={styles.section}>
              ...
              <p className={styles.bold}>
                ...
                предпринимаемые ООО «КСК-СИСТЕМС», ОГРН: 1117847079261, ИНН:
                7841441038 (далее — Оператор).
              </p>
            ...
            <section className={styles.section}>
              ...
              <h3 className={styles.h3}>3.1. Оператор имеет право:</h3>
              <ul className={styles.list}>
                <li>
              ...
              <h3 className={styles.h3}>3.2. Оператор обязан:</h3>
              <ul className={styles.list}>
                <li>
            ...
            <section className={styles.section}>
              ...
              <div className={styles.tableWrapper}>
                <div className={styles.table}>
                  <div className={styles.row + " " + styles.header}>
                    <div className={styles.cell}>Цель обработки</div>
                    <div className={styles.cell}>
                      Продвижение товаров, работ, услуг Оператора на рынке
                    </div>
                  </div>
                  <div className={styles.row}>
                    <div className={styles.cell}>Персональные данные</div>
                    <div className={styles.cell}>
                      <ul>
                        <li>
                          Идентификатор пользователя, хранимый в cookie-файла
                        </li>
                        <li>Сведения, содержащиеся в cookie-файлах</li>
                        <li>Сведения о времени посещения сайта</li>
                        <li>Сведения о пользовательском устройстве</li>
                        <li>IP-адрес</li>
                        <li>Сведения о просмотренных веб-страницах</li>
                        <li>Сведения о нажатии на элементы веб-страниц</li>
                        <li>Данные, собираемые метрическими системами</li>
                      </ul>
                    </div>
                  </div>
                  <div className={styles.row}>
                    <div className={styles.cell}>Правовые основания</div>
                    <div className={styles.cell}>
                      <ul>
              ...
              <p className={styles.bold}>
                На Сайте происходит сбор и обработка обезличенных данных о
                посетителях (в т.ч. файлов «cookie»). Обезличенные данные
                Пользователей, собранные с помощью сервисов интернет-статистики,
                служат для сбора информации о действиях Пользователей на Сайте,
                улучшения качества Сайта и его содержания. Оператор обрабатывает
                обезличенные данные о Пользователе в случае, если это разрешено
                в настройках браузера Пользователя (включено сохранение файлов
                «cookie» и/или использование технологии JavaScript).
              </p>
            </section>
            <section className={styles.section}>
              <h2 className={styles.h2}>
            ...
            <section className={styles.section}>
              ...
              <ul>
                ...
                <li>
                  ...
                  Оператора anna@vibro-laser.com с пометкой «Актуализация
                  персональных данных».
                </li>
                <li>
                  8.4. Срок обработки персональных данных определяется
                  достижением целей, для которых были собраны персональные
                  данные, за исключением cookie-файлов (срок хранения – до 1
                  года). <br />
                  ...
                  anna@vibro-laser.com с пометкой «Отзыв согласия на обработку
                  персональных данных».
                </li>
                <li>
            ...
            <section className={styles.section}>
              <h2 className={styles.h2}>11. Трансграничная передача</h2>
              <ul>
                <li>
                  11.1. Трансграничная передача персональных данных Оператором
                  не осуществляется.
                </li>
              </ul>
            </section>
            <section className={styles.section}>
              <h2 className={styles.h2}>12. Заключительные положения</h2>
              <ul>
                <li>
